...
namespace Universidad.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        {
            //await _context.Alumno.Where(x => x.Estado == 1).ToListAsync()
            var alumno = from s in _context.Alumno
                           select s;
        ...
        public async Task<IActionResult> Create([Bind("Idalumno,Nombre,Apellido1,Apellido2,FechaNacimiento,Estado")] Alumno alumno)
        {
